        ...
        <div className='post-carousel-container container-fluid w-100'>
            ...
            <div className="post-carousel w-100 m-0">
                <Swiper
                    ...
                    breakpoints={{
                        0:{
                            slidesPerView: props.slideNum-3,
                        },
                        576: {
                          slidesPerView: props.slideNum-2,
                        },
                        768: {
                          slidesPerView: props.slideNum-1,
                        },
                        992: {
                            slidesPerView: props.slideNum,
                        },
  
                      }}
                >
                    {contentArray.slice(0,9).map((item,index)=>{
                        if(props.cardStyle==="full-image"){
                            return(
                                <SwiperSlide key={index}>
                                    <div className="post-card-full-image h-100">
                                        <Link to={"#"}>
                                            <div className="image">
